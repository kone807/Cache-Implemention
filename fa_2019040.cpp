...
void FAsearch(Block main_memory[], int mlines, Set cache_memory[], int clines, int address, int n, int num_words)
{
...
void FAwrite(Block main_memory[], int mlines, Set cache_memory[], int num_sets, int address, int value, int n, int num_words)
{
    int offset = address%num_words;
    int block_number = address/num_words;
...
int main()
{
  ...
  //  printMainMemory(main_memory, mlines, num_words);
    ...
    if(instruction.substr(0,4) == "read")
    {
        ...
        FAsearch(main_memory, mlines, cache_memory, clines, address, n, num_words);
   ...
   else if(instruction.substr(0,5) == "write")
   {
       ...
       FAwrite(main_memory, mlines, cache_memory, clines, address, value, n, num_words);
